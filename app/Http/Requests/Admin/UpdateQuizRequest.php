...
class UpdateQuizRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($this->input('quiz_type') === 'custom') {
            ...
            $rules['ai_questions.*.explanation'] = ['nullable', 'string'];

            // AI generation fields (not stored, just for generation)
            $rules['theme_id'] = ['required_if:quiz_type,ai', 'string'];
    ...
    public function messages(): array
    {
        return [
            ...
            'questions.max' => 'You can add maximum ten questions.',
            ...
            'ai_questions.max' => 'You can add maximum ten questions.',
    ...
    /**
     * Validate that the correct option index is valid for each question.
     */
