...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        $posts = $this->post_service->getPostsListForCompanyAdmin($companyId);
        return view('company_admin.social-feed.index', compact('posts'));
    }
    ...
    {
        return view('company_admin.social-feed.create');
    }
    ...
    public function store(CreatePostRequest $request)
    {
        try {
            ...
            return response()->json([
                'redirect' => route('company_admin.social-feed.index'),
                'message' => $response['message']
            ]);
        } catch (\Exception $e) {
    ...
    public function show(string $id)
    {
        ...
        return view('company_admin.social-feed.view', compact('post'));
    }
    ...
    {
        $post = $this->post_service->getAdminPostDetail($id);
        return view('company_admin.social-feed.edit', compact('post'));
    }
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return response()->json([
                'redirect' => route('company_admin.social-feed.list'),
                'message' => $response['message']
            ]);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function getReportedPosts()
    {
        ...
        $reported_posts = $this->post_service->getReportedPostsList($companyId);
        return view('company_admin.social-feed.reports', compact('reported_posts'));
    }

    public function reportedUsersList($id)
    {
        $reports = $this->post_service->getReportedUsersList($id);
        return view('company_admin.social-feed.reported-users', compact('reports'));
    }

    public function reportedUsersDetail($id)
    {
        $report = $this->post_service->getReportedUsersDetails($id);
        return view('company_admin.social-feed.reported-users-detail', compact('report'));
    }
