    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="vh-100">
            ...
            <div class="pd-20 card-box mb-30">
                <form action="{{ route('admin.inspiration-challenges.update', $challenge->id) }}"
                    ...
                    <div class="row">
                            ...
                            <select name="company_id" id="company-select" class="custom-select2 form-control">
                                ...
                                @foreach ($companies as $company)
                                    <option value="{{ $company->id }}"
                                        {{ $challenge->company_id == $company->id ? 'selected' : '' }}>
                                        {{ $company->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 col-sm-12 ml-0" id="validation-mode">
                            ...
                            <select name="mode" id="mode-select" class="custom-select2 form-control"
                                ...
                                <option value="checkbox" {{ $challenge->mode === 'checkbox' ? 'selected' : '' }}>Checkbox
                                </option>
                            </select>
                            <div class="form-control-feedback mt-2 d-none"></div>
                        </div>
                        <div class="col-md-6 col-sm-12 ml-0 event-column @if ($challenge->challenge_category_id == 1) d-none @endif ">
                            ...
                            <input name="event_name" id="event-name" value="{{ $challenge->event->title ?? '' }}"
                        ...
                        <div class="col-md-6 col-sm-12 ml-0 event-column @if ($challenge->challenge_category_id == 1) d-none @endif  ">
                            ...
                            <select name="event_type" id="event-select" class="custom-select2 form-control"
                                onchange="handleEventTypeChange(this)">
                        ...
                        <div class="col-md-6 col-sm-12 ml-0 event-column @if ($challenge->challenge_category_id == 1) d-none @endif">
                            ...
                            <input name="event_location" id="event-location" class="form-control"
                                placeholder="Enter event location" value="{{ $challenge->event->location ?? '' }}">
                            <div class="form-control-feedback mt-2 d-none"></div>
                        </div>
                        <div class="col-md-6 col-sm-12 event-column @if ($challenge->challenge_category_id == 1) d-none @endif">
                            ...
                            <input type="text" name="event_start_date"
                                @if ($challenge->event) value="{{ \Carbon\Carbon::parse($challenge->event->start_date)->format('d F Y') }}" @endif
                                class="form-control date-picker" placeholder="Enter Event Start Date" autocomplete="off">
                            <div class="form-control-feedback mt-2 d-none"></div>
                        </div>
                        <div class="col-md-6 col-sm-12 event-column @if ($challenge->challenge_category_id == 1) d-none @endif">
                            <label class="form-control-label">Event End Date*</label>
                            <input type="text" name="event_end_date"
                                @if ($challenge->event) value="{{ \Carbon\Carbon::parse($challenge->event->end_date)->format('d F Y') }}" @endif
                                class="form-control date-picker" placeholder="Enter Event End Date" autocomplete="off">
                            <div class="form-control-feedback mt-2 d-none"></div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                        ...
                        <div class="col-md-6 col-sm-12" id="photo-field">
                            ...
                            <div class="custom-file">
                                ...
                                @if ($challenge->image_path)
                                    <a href="{{ asset($challenge->image_path) }}" target="_blank"> View Uploaded
                                        Image</a>
                                @endif
                                <div class="form-control-feedback mt-2 d-none"></div>
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12" id="video-field">
                            ...
                            <input type="text" name="video_url" class="form-control"
                                value="{{ $challenge->video_url }}" placeholder="Enter guideline video url">
                            <div class="form-control-feedback mt-2 d-none"></div>
                        </div>
                        <div class="col-md-6 col-sm-12">
