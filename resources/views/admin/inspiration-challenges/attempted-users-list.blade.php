                ...
                <div class="pb-20">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover nowrap">
                            ...
                            @include('admin.inspiration-challenges.partials.attempted-users-table')
                        </table>
                    </div>
                    <!-- Pagination -->
...
@push('scripts')
    ...
    <script>
        initAjaxSearch({
            ...
            url: "{{ route('admin.inspiration-challenges.attempted-users-list', $challenge_step_id) }}",
            switchery: false,
            delay: 400
        });
    </script>
