...
@section('content')
                ...
                <div class="pb-20">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover nowrap">
                            ...
                            @include('admin.inspiration-challenges.partials.user-requests-table', ['companies' => $companies])
                        </table>
                    </div>
                    <!-- Pagination -->
    ...
    @include('admin.inspiration-challenges.export-modal')
@endsection
...
@push('scripts')
    ...
    <script>
        initAjaxSearch({
            ...
            url: "{{ route('admin.inspiration-challenges.pending') }}",
            switchery: false,
            delay: 400
        });
    </script>
