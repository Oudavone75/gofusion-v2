    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="vh-100">
            <div class="page-header">
                <div class="row d-flex justify-content-between">
                    @include('admin.components.page-title', [
                        'page_title' => 'Import Inspiration Challenge',
                        'paths' => breadcrumbs(),
                    ])
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form action="{{ route('admin.import-file.import-inspirational-challenge') }}"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 ml-0">
                            ...
                            <select name="type" id="type-column" class="custom-select2 form-control">
                                <option value="for_company">For Company</option>
                                <option value="for_citizen">For Citizen</option>
                            </select>
...
@push('scripts')
    ...
    <script>
        $("#type-column").on('change', function() {
            const value = $(this).val();
            if (value === 'for_citizen') {
                $('select[name=company_id]').parent().addClass('d-none');
                $('select[name=department_id]').parent().addClass('d-none');
            } else {
                $('select[name=company_id]').parent().removeClass('d-none');
                $('select[name=department_id]').parent().removeClass('d-none');
            }
        });
    </script>
@endpush
