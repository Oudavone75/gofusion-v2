    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <p class="text-muted mb-4">Select your export criteria to download the Challenges data.</p>
                <form action="{{ route('admin.inspiration-challenges.export') }}" method="GET" id="exportForm">
                    ...
                    <div class="form-group">
                        ...
                        <select name="company_id" id="quiz-company-select"
