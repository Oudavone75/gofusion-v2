            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 d-flex justify-content-end text-right">
                        <a href="{{ route('admin.sub-admins.create') }}" class="btn btn-primary">Create</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" class="switch-btn"
                                                data-url="{{ route('admin.sub-admins.toggle-status', $sub_admin->id) }}"
                                                {{ $sub_admin->status ? 'checked' : '' }}>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.sub-admins.view', $sub_admin->id) }}"><i
                                                            class="dw dw-eye"></i> View</a>
                                                    @if (auth('admin')->user()->hasDirectPermission('edit survey feedback'))
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.sub-admins.edit', $sub_admin->id) }}"><i
                                                    ...
                                                    @if (auth('admin')->user()->hasDirectPermission('delete survey feedback'))
                                                        <a class="dropdown-item delete-image-sub_admin" href="#"
                                                            ...
                                                            data-url="{{ route('admin.sub-admins.delete', $sub_admin->id) }}">
