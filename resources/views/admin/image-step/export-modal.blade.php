    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <p class="text-muted mb-4">Select your export criteria to download the Image Step
                    attempted users data.</p>
                <form action="{{ route('admin.images.export', $go_session_step_id) }}" method="GET"
                    id="exportForm">
                    <div class="form-group">
                        <label class="form-label fw-semibold">
                            Export Format <span class="text-danger">*</span>
                        </label>
                        <select name="type" id="export_format" class="form-control" required>
            ...
            <div class="modal-footer border-0 pt-0">
                <button type="button" class="btn export-btn-light btn-lg" data-dismiss="modal" aria-label="Close">
                    Cancel
                </button>
