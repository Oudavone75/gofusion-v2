                    ...
                    <div class="col-md-6 col-sm-12 d-flex justify-content-end text-right">
                        ...
                        <div class="dropdown mx-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" style="">
                                <a class="dropdown-item" href="{{ route('admin.images.index') }}?type=campaign">Campaign</a>
                                <a class="dropdown-item" href="{{ route('admin.images.index') }}?type=season">Season</a>
                            </div>
                        </div>
                        @if (auth('admin')->user()->hasDirectPermission('create challenges'))
                            <a href="{{ route('admin.images.create') }}" class="btn btn-primary">Create</a>
                        @endif
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                @forelse($image_steps as $step)
                                    <tr>
                                        ...
                                        <td>{{ $step->points }}</td>
                                        <td>
                                            @if (auth('admin')->user()->hasDirectPermission('view challenges attempted users'))
                                                <a class="badge badge-primary"
                                                    href="{{ route('admin.images.attempted-users', [$step->id, activeCampaignSeasonFilter()]) }}">
                                        ...
                                        <td>
                                            @if (auth('admin')->user()->hasDirectPermission('view challenges user requests'))
                                                <a class="badge badge-primary"
                                                    href="{{ route('admin.images.appealing-users', [$step->id, activeCampaignSeasonFilter()]) }}">
                                                    {{ $step->appealing_attempts_count }} </a>
                                            @else
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                        @if (auth('admin')->user()->hasDirectPermission('edit challenges'))
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.images.edit', $step) }}"><i
                                                        ...
                                                        @if (auth('admin')->user()->hasDirectPermission('delete challenges'))
                                                            <a class="dropdown-item delete-image-step" href="#"
                                                                ...
                                                                data-url="{{ route('admin.images.destroy', $step->id) }}">
                                                                <i class="icon-copy fa fa-trash" aria-hidden="true"></i>
                                                                Delete</a>
                                                        @endif
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.images.show', $step) }}"><i
