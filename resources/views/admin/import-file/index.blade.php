        ...
        <div class="vh-100">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <ul class="p-3">
                    ...
                    <li>2. Download and fill in an Excel file (template below) with your own data.</li>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form action="{{ route('admin.import-file.import') }}" onsubmit="submitFileImportForm(event, this);"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 ml-0 company-select">
                            ...
                            <select name="company" id="company-select"
                                onchange="getSelectDataImportFile(this,'campaign-select','Campaigns','company_id','campaign')"
