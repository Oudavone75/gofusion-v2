            ...
            <div class="col-md-6 col-lg-5">
                <div class="login-box bg-white box-shadow border-radius-10">
                    ...
                    <form method="POST" action="{{ route('admin.login.post') }}">
                        ...
                        <div class="row pb-30">
                            <div class="col-12">
                                <div class="forgot-password text-center"><a href="{{ route('admin.forgot.password') }}">Forgot Password</a></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="input-group mb-0">
                                    <button id="sign-in-button" class="btn btn-lg btn-block common-button-pink" href="{{ route('admin.dashboard') }}">Sign In</button>
                                </div>
                            </div>
                        </div>
                    </form>
