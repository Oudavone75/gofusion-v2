    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="vh-100">
            <div class="page-header">
                <div class="row">
                    @include('admin.components.page-title', [
                        'page_title' => 'Add Challenge Step', 'paths' => breadcrumbs()
                    ])
                </div>
            </div>
            @if (session('error'))
            ...
            <div class="pd-20 card-box mb-30">
                <form action="{{ route('admin.challenges-step.store') }}" onsubmit="submitForm(event,this,'/admin/challenges-step'+TYPE_QUERY_PARAM,true)"
