...
@section('content')
    <div class="pd-ltr-20 xs-pd-20-10">
        ...
        <div class="card-box p-4 shadow-sm mb-30 rounded">
            {{-- Edit Form --}}
            <form action="{{ route('admin.social-feed.update', $post['data']->id) }}" method="POST"
                                    ...
                                    <div class="card-footer bg-white border-0 text-center p-2">
                                        <div class="btn-group btn-group-sm w-100" role="group">
                                            ...
                                            <button type="button" onclick="deleteRecord(this)"
                                                data-url="{{ route('admin.social-feed.delete-media', $media->id) }}"
                ...
                <div class="text-right mt-4">
                    <a href="{{ route('admin.social-feed.list') }}" class="btn btn-secondary px-4 mr-2">
