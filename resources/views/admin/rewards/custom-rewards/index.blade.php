                    ...
                    <div class="col-md-6 col-sm-12 d-flex justify-content-end text-right">
                        @if (activeCampaignSeasonFilter() == 'campaign')
                            @include('admin.filters.company-filter', [
                                'route_name' => 'admin.rewards.custom.index',
                            ])
                        @endif
                        <div class="dropdown mx-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" style="">
                                <a class="dropdown-item"
                                    href="{{ route('admin.rewards.custom.index') }}?type=campaign">Campaign</a>
                                <a class="dropdown-item"
                                    href="{{ route('admin.rewards.custom.index') }}?type=season">Season</a>
                            </div>
                        </div>
                        @if (auth('admin')->user()->hasDirectPermission('create custom rewards'))
                        <a href="{{ route('admin.rewards.custom.create') }}" class="btn btn-primary">Create</a>
                        @endif
                    </div>
                        ...
                        <table class="table table-hover nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>Status</th>
                                    @if (auth('admin')->user()->hasDirectPermission('edit custom rewards') || auth('admin')->user()->hasDirectPermission('view custom rewards'))
                                    <th>Action</th>
                                    @else
                                        <th></th>
                                    @endif
                            ...
                            <tbody>
                                @forelse($campaigns as $campaign)
                                    <tr>
                                        ...
                                        @if (auth('admin')->user()->hasDirectPermission('manage custom rewards status'))
                                        <td>
                                            <input type="checkbox" class="switch-btn"
                                                data-url="{{ route('admin.rewards.custom.toggle-status', $campaign->id) }}"
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.rewards.custom.view', $campaign->id) }}"><i
                                                            class="dw dw-eye"></i> View</a>
                                                    @if (auth('admin')->user()->hasDirectPermission('edit custom rewards'))
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.rewards.custom.edit', $campaign->id) }}"><i
