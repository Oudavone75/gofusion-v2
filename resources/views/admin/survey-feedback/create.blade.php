            ...
            <div class="page-header">
                <div class="row">
                    @include('admin.components.page-title', [
                        'page_title' => 'Add Survey / Feedback', 'paths' => breadcrumbs()
                    ])
                </div>
            </div>
            <div class="pd-20 card-box mb-30">
                <form action="{{ route('admin.survey-feedback.store') }}" method="POST" enctype="multipart/form-data"
                    id="survey-feedback-form">
                    @csrf
                    <!-- Common Fields -->
                    @include('admin.survey-feedback._common-fields')
