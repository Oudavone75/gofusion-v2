    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    @include('admin.components.page-title', ['page_title' => 'Employee Performance Detail'])
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <form method="GET" action="{{ route('admin.performance.employee-detail', $user->id) }}" class="d-flex justify-content-end">
