...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="vh-100">
        ...
        <div class="pd-20 card-box mb-30">
            <form action="{{ route('admin.quiz.store') }}" method="POST" enctype="multipart/form-data" id="quiz-form">
                @csrf
                <input type="hidden" name="quiz_type" id="quiz-type-input" value="custom">
                <!-- Common Fields -->
                @include('admin.quiz._common-fields')
                <!-- Quiz Type Selection -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <textarea name="ai_rules" class="form-control" rows="4"
                                    placeholder="Tell AI exactly what kind of quiz to create (e.g. 'Create a 5-question quiz about climate change with medium difficulty. Focus on renewable energy solutions.'). An explanation for the correct answer will be automatically generated for each question.">{{ old('ai_rules') }}</textarea>
