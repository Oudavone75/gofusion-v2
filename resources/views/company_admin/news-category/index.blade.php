            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <a href="{{ route('company_admin.news-category.create') }}" class="btn btn-primary">Create</a>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <a class="dropdown-item"
                                                        href="{{ route('company_admin.news-category.edit', $news_category) }}"><i
                                                            class="dw dw-edit2"></i> Edit</a>
                                                    <a class="dropdown-item delete-news-category" href="#"
                                                        onClick="deleteRecord(this)" data-id="{{ $news_category->id }}"
                                                        data-name="{{ $news_category->title }}"
                                                        data-url="{{ route('company_admin.news-category.destroy', $news_category->id) }}">
                                                        <i class="icon-copy fa fa-trash" aria-hidden="true"></i> Delete</a>

                                                    <a class="dropdown-item"
                                                        href="{{ route('company_admin.news-category.show', $news_category->id) }}"><i
