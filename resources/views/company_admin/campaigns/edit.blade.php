    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="vh-100">
            ...
            <div class="pd-20 card-box mb-30">
                <form action="{{ route('company_admin.campaigns.update', $campaign->id) }}"
                    onsubmit="submitForm(event,this,'/company-admin/campaigns',true)" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <textarea name="description" class="form-control"
                                placeholder="Enter Description" rows="4">{{ old('description', $campaign->description) }}</textarea>
                            <div class="form-control-feedback mt-2 d-none"></div>
                        </div>
                        ...
                        <div class="row" id="department-wrapper">
                            ...
                            <div class="col-md-12 col-sm-12 mt-2 d-flex align-items-center reward-field">
                                <div class="col-md-3">
                                    ...
                                    <input type="number" name="from_ranking[]" value="{{ old('from_ranking[]') ?? $range->rank_start }}"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" name="to_ranking[]" value="{{ old('to_ranking[]') ?? $range->rank_end }}"
                                        class="form-control" required
