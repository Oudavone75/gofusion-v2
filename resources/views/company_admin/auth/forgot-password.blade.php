            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        ...
                        <form method="POST" action="{{ route('company_admin.forgot.password.post') }}" onsubmit="disableSubmitButton(this)">
                            @csrf
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-5">
                                    <div class="input-group mb-0">
                                        <a class="btn btn-outline-info btn-lg btn-block" style="font-size: 12px;" href="{{ route('company_admin.login') }}">Login</a>
                                    </div>
                                </div>
                            </div>
                        </form>
