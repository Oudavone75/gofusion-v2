        ...
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    ...
                    @if(auth('web')->user()->hasDirectPermission('create gallery'))
                        <div class="col-md-6 col-sm-12 text-right">
                            <a class="btn btn-primary" href="{{ route('company_admin.gallery.create') }}" role="button">
                                Upload Gallery
                            </a>
                        </div>
                    @endif
                                    ...
                                    <div class="da-overlay">
                                        <div class="da-social">
                                            ...
                                            <ul class="clearfix">
                                                ...
                                                @if(auth('web')->user()->hasDirectPermission('delete gallery'))
                                                    <li>
                                                        <a href="#" data-id="{{ $gallery_image->id }}"
                                                            data-url="{{ route('company_admin.gallery.delete', $gallery_image->id) }}"
