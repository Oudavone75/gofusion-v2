    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form class="dropzone" id="gallery-dropzone" action="{{ route('company_admin.gallery.store') }}">
                    @csrf
                    <div class="fallback">
...
@push('scripts')
    <script>
        const galleryStoreUrl = "{{ route('company_admin.gallery.store') }}";
        const galleryIndexUrl = "{{ route('company_admin.gallery.index', ['company_id' => auth('web')->user()->company->id]) }}";
