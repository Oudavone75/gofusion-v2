            ...
            <div class="page-header">
                <div class="row">
                    @include('company_admin.components.page-title', [
                        'page_title' => 'Add Inspiration Challenge',
                        'paths' => breadcrumbs()
                    ])
                </div>
            </div>
            <div class="pd-20 card-box mb-30">
                <form action="{{ route('company_admin.inspiration-challenges.store') }}"
                      onsubmit="submitForm(event,this,'/company-admin/inspiration-challenges',true)"
                ...
                >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <input type="number" name="attempted_points" class="form-control" placeholder="Enter Points (1-300)">
                            <div class="form-control-feedback d-none"></div>
                        </div>
