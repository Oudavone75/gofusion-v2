                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <!-- Accept Button -->
                                            <form
                                                action="{{ route('company_admin.steps.challenges-step.status', 'accept') }}"
                                            ...
                                            <!-- Reject Button -->
                                            <form
                                                action="{{ route('company_admin.steps.challenges-step.status', 'reject') }}"
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item"
                                                    href="{{ route('company_admin.steps.challenges-step.attempted-user.details', [$user->id, $user->challenge_attempts[0]->go_session_step_id]) }}"><i
