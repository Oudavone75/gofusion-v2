    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <p class="text-muted mb-4">Select your export criteria to download the Survey
                    attempted users data.</p>
                <form action="{{ route('company_admin.steps.survey-feedback.export', $go_session_step_id) }}" method="GET"
                    id="exportForm">
