        ...
        <div class="min-height-200px">
            ...
            <div class="page-header">
                <div class="row">
                    ...
                    @if (auth('web')->user()->hasDirectPermission('export survey feedback attempted users'))
                    ...
                    @endif
                    @include('company_admin.session-steps.survey-feedback.export-modal', [
                        ...
                        <tbody>
                            @forelse($users as $user)
                                <tr>
                                    ...
                                    <td>{{ $user->survey_feedback_attempts[0]?->points }}</td>
                                    <td>
                                        {{ \Carbon\Carbon::parse($user->registeration_date)->format('d M Y') }}</td>
                                    <td>
                                        {{ \Carbon\Carbon::parse($user->survey_feedback_attempts[0]?->created_At)->format('d M Y') }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
