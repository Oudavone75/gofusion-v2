    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="vh-100">
            <div class="page-header">
                <div class="row">
                    @include('company_admin.components.page-title', [
                        'page_title' => 'Edit Challenges to Complete Step',
                        'paths' => breadcrumbs()
                    ])
                </div>
            </div>
            ...
            <div class="pd-20 card-box mb-30">
                <form action="{{ route('company_admin.steps.images.update', $image_step->id) }}"
                    onsubmit="submitForm(event,this,'/company-admin/steps/images',true)" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <textarea name="description" class="form-control" placeholder="Enter Description" rows="4">{{ old('description', $image_step->description) }}</textarea>
                            <div class="form-control-feedback mt-2 d-none"></div>
                        </div>
