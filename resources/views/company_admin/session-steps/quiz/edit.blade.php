...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="vh-100">
        ...
        <div class="pd-20 card-box mb-30">
            <form action="{{ route('company_admin.steps.quiz.update', $quiz->id) }}" method="POST" enctype="multipart/form-data" id="quiz-form">
                @csrf
                @method('PUT')
                ...
                @endif
                @include('company_admin.session-steps.quiz._common-fields', ['quiz' => $quiz])
                <!-- Quiz Type Selection -->
                    ...
                    <div class="tab-pane fade {{ $quiz->quiz_type === 'ai' ? 'show active' : '' }}" id="ai" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <input type="number" name="num_questions" value="{{ old('num_questions', $quiz->num_questions ?? 5) }}" class="form-control">
                            </div>
                            <div class="col-md-6 col-sm-12">
