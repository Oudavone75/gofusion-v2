...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="vh-100">
        ...
        <div class="pd-20 card-box mb-30">
            <form action="{{ route('company_admin.steps.events.update', $event_step->id) }}" onsubmit="submitForm(event,this,'/company-admin/steps/events',true)"
