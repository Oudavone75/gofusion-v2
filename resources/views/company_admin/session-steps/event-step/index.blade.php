            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <a href="{{ route('company_admin.steps.events.create') }}" class="btn btn-primary">Create</a>
                    </div>
                </div>
            </div>
                            ...
                            @forelse($event_steps as $step)
                                <tr>
                                    ...
                                    <td><a class="badge badge-primary"
                                            href="{{ route('company_admin.steps.events.attempted-users', $step->id) }}">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item"
                                                    href="{{ route('company_admin.steps.events.edit', $step) }}"><i
                                                        class="dw dw-edit2"></i> Edit</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('company_admin.steps.events.show', $step) }}"><i
                                                        class="dw dw-eye"></i> View</a>
                                                <a class="dropdown-item delete-event-step" href="#"
                                                    onClick="deleteRecord(this)" data-id="{{ $step->id }}"
                                                    data-name="{{ $step->title }}"
                                                    data-url="{{ route('company_admin.steps.events.destroy', $step->id) }}">
